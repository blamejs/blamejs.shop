  ...
  return {
    ...
    recordCommissionEvent: async function (input) {
      ...
      try {
        ...
        // writer loses on the UNIQUE constraint. Converge on the committed row
        // (idempotent) instead of throwing an unhandled error — matching the
        // sequential dedup contract and mirroring _insertAffiliate's
        // UNIQUE-retry shape.
