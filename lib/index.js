...
Object.assign(module.exports, {
  ...
  marketingBudget:       require("./marketing-budget"),
  orderExchanges:        require("./order-exchanges"),
  disputeResolution:     require("./dispute-resolution"),
  operatorSessions:      require("./operator-sessions"),
  shippingInsurance:     require("./shipping-insurance"),
  pwaManifest:           require("./pwa-manifest"),
  searchRanking:         require("./search-ranking"),
  emailABTests:          require("./email-ab-tests"),
  operatorInbox:         require("./operator-inbox"),
  demandForecast:        require("./demand-forecast"),
  ...
  shrinkageReport:       require("./shrinkage-report"),
  subscriptionAnalytics: require("./subscription-analytics"),
  operatorActivityFeed:  require("./operator-activity-feed"),
  referralLeaderboard:   require("./referral-leaderboard"),
  fulfillmentSLA:        require("./fulfillment-sla"),
  binLocations:          require("./bin-locations"),
  salesTaxFilings:       require("./sales-tax-filings"),
  suggestionBox:         require("./suggestion-box"),
  emailEngagementScore:  require("./email-engagement-score"),
  customerImpersonation: require("./customer-impersonation"),
  carrierAccounts:       require("./carrier-accounts"),
  operatorApprovals:     require("./operator-approvals"),
  lineGiftWrap:          require("./line-gift-wrap"),
  productCompare:        require("./product-compare"),
  customerMerge:         require("./customer-merge"),
  taxRemittance:         require("./tax-remittance"),
  eventLog:              require("./event-log"),
  categoryNavigation:    require("./category-navigation"),
  inventoryAudits:       require("./inventory-audits"),
  vendorInvoices:        require("./vendor-invoices"),
  blogArticles:          require("./blog-articles"),
  smartRestocking:       require("./smart-restocking"),
